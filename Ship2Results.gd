...
func calculate_rating() -> String:
	...
	for p in placeables:
		points += p.elegant_value * 0.2
		points += p.rustic_value * -0.8
		points += p.futuristic_value * 0
		points += p.modern_value * 1.2
		points += p.otherworldly_value * -0.8
